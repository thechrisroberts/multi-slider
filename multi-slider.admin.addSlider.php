<?php
function mslider_addSlider_panel()
{
	$mslider_errors = "";
	$mslider_passed_slug = "";
	...
	mslider_output_add_form($mslider_sliderAction, $mslider_passed_slug, $mslider_slider_settings, $mslider_errors);
}

function mslider_output_add_form($mslider_sliderAction, $mslider_passed_slug, $mslider_slider_settings, $mslider_errors)
{
	?>
